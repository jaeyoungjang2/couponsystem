package com.example.coupon.v8.api
...
import com.example.coupon.v8.application.CouponServiceV8
import org.springframework.http.HttpStatus
import org.springframework.http.ResponseEntity
import org.springframework.web.bind.annotation.*

@RestController
@RequestMapping("/api/v8/coupons")
class CouponControllerV8(
    private val couponServiceV8: CouponServiceV8,
) {

    @PostMapping
    fun create(@RequestBody request: CreateCouponRequest): ResponseEntity<CouponResponse> {
        val coupon = couponServiceV8.createCoupon(request)
    ...
    fun issue(
        ...
        val issuance = couponServiceV8.issue(couponId, userId)
